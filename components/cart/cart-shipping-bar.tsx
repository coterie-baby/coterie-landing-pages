    ...
    <div className="py-3">
      {hasFreeShipping ? (
        <div className="flex items-center justify-between w-full">
          <p style={{ fontFamily: "Suisse Int'l Mono", fontSize: '10px', fontStyle: 'normal', fontWeight: 400, lineHeight: '140%', letterSpacing: '-0.6px', color: '#0000C9' }}>Congratulations! You&apos;re getting free shipping!</p>
